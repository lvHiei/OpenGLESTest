...
public class OpenGLUtils {
	...
	public static int loadRepeatTexture(final Context context, final String name){
		final int[] textureHandle = new int[1];
	...
	public static int loadMirrorRepeatTexture(final Context context, final String name){
		final int[] textureHandle = new int[1];
